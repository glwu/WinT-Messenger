...
DeviceManager::DeviceManager() {
    ...
    // Most systems, such as iOS will report a logical DPI of 72, and will handle
    // all the scaling code using their own methods, so scaling the interface would
    // only create a window of oportunity for obtaining a screwed display...
    else
      screenRatio = 1.0;
}
