...
QtObject {
    ...
    function setColors() {
        ...
        navigationBar            = settings.customColor() ? primary : settings.darkInterface() ? "#383838" : "#666"
