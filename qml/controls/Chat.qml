...
Page {
    ...
    rightWidgets: [
        ...
        Button {
            ...
            Badge {
                text: downloadsModel.count
                opacity: downloadsModel.count > 0 ? 1 : 0
            }
                ...
                Column {
                    ...
                    Controls.ScrollView {
                        ...
                        ListView {
                            ...
                            // Create the list model with all the downloads
                            model: ListModel {
                                id: downloadsModel
                            ...
                            delegate: Rectangle {
                                ...
                                Connections {
                                    ...
                                    onClearDownloads: progressBar.value == 100 ? destroy() : undefined
                                }
