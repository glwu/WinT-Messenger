...
!define APPNAME "WinT Messenger"
!define COMPANYNAME "WinT 3794"
!define DESCRIPTION "Simple and lightweight IM client"
!define VERSIONMAJOR 1
!define VERSIONMINOR 4
!define VERSIONBUILD 12
!define ESTIMATED_SIZE 66782
!define MUI_ABORTWARNING
!define INSTALL_DIR "$PROGRAMFILES\${COMPANYNAME}\${APPNAME}"
...
Section "Start Menu Shortcuts"
  ...
  CreateShortCut "$SMPROGRAMS\${COMPANYNAME}\${APPNAME}.lnk" "${INSTALL_DIR}\${APPNAME}.exe" "" "${INSTALL_DIR}\${APPNAME}.exe" 0
SectionEnd
